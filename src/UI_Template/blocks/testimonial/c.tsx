...
function LightTestimonialC(props:any) {
  return (
        ...
        <div className="flex flex-wrap -m-4">
          <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
            <div className="h-full text-center">
              ...
              <pre className="text-gray-500">Senior Product Designer</pre>
            </div>
          </div>
          <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
            <div className="h-full text-center">
              ...
              <pre className="text-gray-500">UI Develeoper</pre>
            </div>
          </div>
          <div className="lg:w-1/3 lg:mb-0 p-4">
            <div className="h-full text-center">
              ...
              <pre className="text-gray-500">CTO</pre>
            </div>
          </div>
        </div>
      </div>
